...
# -------------------------------
data = {
    "GPT 4o": {"SBS": {"DP": [9, 21], "PD": [1, 29]}, "EOS": {"DP": [30, 0], "PD": [1, 29]}},
    "Claude 3.7 Sonnet": {"SBS": {"DP": [29, 1], "PD": [25, 5]}, "EOS": {"DP": [30, 0], "PD": [13, 17]}}, 
    "Claude 4 Sonnet": {"SBS": {"DP": [30, 0], "PD": [29, 1]}, "EOS": {"DP": [30, 0], "PD": [6, 24]}},
    "Gemini 2.5 Flash": {"SBS": {"DP": [30, 0], "PD": [30, 0]}, "EOS": {"DP": [30, 0], "PD": [30, 0]}},
    "Llama-4-Maverick": {"SBS": {"DP": [18, 12], "PD": [1, 29]}, "EOS": {"DP": [30, 0], "PD": [24, 6]}},
    "Qwen2.5": {"SBS": {"DP": [30, 0], "PD": [30, 0]}, "EOS": {"DP": [17, 13], "PD": [4, 26]}},
}
